...
static void generateTelemetryPayload()
{
  ...
  myObject["device_id"] = DEVICE_ID;
  myObject["temperature"] = temp;
  myObject["sampled_at"] = rtc.getEpoch();
  telemetry_payload = JSON.stringify(myObject);
}

static void sendTelemetry()
{
  Logger.Info("Sending telemetry ...");
  Logger.Info(String(rtc.getDateTime()));
