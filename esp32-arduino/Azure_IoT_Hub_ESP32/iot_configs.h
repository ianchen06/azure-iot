...
// Wifi
#define IOT_CONFIG_WIFI_SSID "my-wifi-ssid"
#define IOT_CONFIG_WIFI_PASSWORD "my-wifi-password"
...
// Azure IoT
#define IOT_CONFIG_IOTHUB_FQDN "<your-azure-iot>.azure-devices.net"
